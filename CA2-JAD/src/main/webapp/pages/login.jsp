<%-- In the scriplet below put request.getAttribute(sessionUserId) or wtv, then the if else u display this or u display another thing --%>
...
<html>
  ...
  <body>
    <div class="main">
      ...
      <div class="customer">
    <form action="/JAD-Assignment/VerifyUserServlet" name="loginForm" method="post">
        <label for="chk" aria-hidden="true">Customer</label>
        <input type="text" name="loginid" placeholder="Username" />
        <input type="password" name="password" placeholder="Password" />
        <button>Sign in as customer</button>
    </form>
    <a class="signUpPage" href="signUp.jsp">Don't have an account? <span class="signUpBtn">Sign Up</span></a>
</div>
 ...
 <button
    class="continueGuestButton"
    onclick="window.location.href='landing.jsp?role=guest'"
  >
    Continue as Guest
  </button>
